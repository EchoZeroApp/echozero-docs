...
| **Success fee** | Subscriber on profitable trades | You set `successFeePercent` on the agent (e.g. 10-20% of trade notional) | **80%** of collected success fee (platform **20%**) |
| **Both** | Subscribers | Subscription + success fee | Combined per above |

### Worked example: success fee

Subscriber executes a **$10,000** buy. Your agent `successFeePercent` is **15%**.

1. Success fee assessed: $10,000 × 15% = **$1,500**
2. Platform share (20%): **$300**
3. Your net success fee: **$1,200** (claimable via strategy-fee claims)
