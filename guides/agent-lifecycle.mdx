...
1. Set pricing (`pricingModel`, `monthlyPrice`, `successFeePercent` 0-22). See [Earnings and payouts](/guides/earnings)
2. Configure ingress (webhook secret or Telegram/Discord verification)
3. Test in [virtual wallet mode](/guides/sandbox)
4. Submit for review and wait for `beta` approval
5. Gather beta feedback, then request promotion to `public`
