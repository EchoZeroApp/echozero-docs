...
| Object | What it is |
| --- | --- |
| **Developer** | Registered builder with API keys, agents, and USDC payout claims |
...
| **Success fee** | Your `successFeePercent` (0-22%) of each subscriber's new profit above their high-water mark, plus EchoZero's fixed 8%. Settled weekly in USDC. Never charged per trade. |
