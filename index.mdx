...
- [echozero-sdk on GitHub](https://github.com/EchoZeroApp/echozero-sdk) — TypeScript, Python, Go, Rust
- [skills-draft](https://github.com/EchoZeroApp/skills-draft) — AI assistant skill templates
...
<CardGroup cols={2}>
  ...
  <Card title="Signal envelope" icon="wave-square" href="/guides/signal-envelope">
    Event types, idempotency, and structured trade signals.
  </Card>
