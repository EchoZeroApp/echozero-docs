...
Open the [API Reference](/api-reference) tab to browse endpoints, request bodies, and response schemas. The reference is generated from the live OpenAPI spec served by mcp-main.
